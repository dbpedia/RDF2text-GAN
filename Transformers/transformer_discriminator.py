...
Original file is located at
    https://colab.research.google.com/drive/1ssoPX_pSpeJWRl-dDOKFwNSVowMd1-7N

# Text classification with Transformer

**Original Author:** [Apoorv Nandan](https://twitter.com/NandanApoorv)<br>
** Modifications by : Niloy Purkait
...
'''
history = model.fit(
    X_train, y_train, batch_size=32, epochs=8, validation_data=(X_test, y_test)
)
'''
